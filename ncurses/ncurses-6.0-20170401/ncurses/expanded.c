...
{
 return ((((TERMTYPE *)(cur_term))-> Strings[105] != 0) ? sp->_dch_cost : ((((TERMTYPE *)(cur_term))-> Strings[21] != 0) ? (sp->_dch1_cost * count) : 1000000));
}

 int
_nc_InsCharCost_sp (SCREEN *sp, int count)
{
 return ((((TERMTYPE *)(cur_term))-> Strings[108] != 0) ? sp->_ich_cost : ((((TERMTYPE *)(cur_term))-> Strings[31] && ((TERMTYPE *)(cur_term))-> Strings[42]) ? sp->_smir_cost + sp->_rmir_cost + (sp->_ip_cost * count) : ((((TERMTYPE *)(cur_term))-> Strings[52] != 0) ? ((sp->_ich1_cost + sp->_ip_cost) * count) : 1000000)));
}
