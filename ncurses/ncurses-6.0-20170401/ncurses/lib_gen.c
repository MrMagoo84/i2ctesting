/* This file was generated by ./base/MKlib_gen.sh */
...
{
	T((T_CALLED("attrset(%s)"), _traceattr2(0,(chtype)z))); returnIntAttr((attr_t)((0 != (const void *)((stdscr))) ? ((stdscr)->_attrs = (attr_t)((z)), (0)) : (-1)));
}


NCURSES_EXPORT(int) (attr_get) (attr_t * a1, short * a2, void * z GCC_UNUSED)
{
	T((T_CALLED("attr_get(%p,%p,%p)"), (const void *)a1, (const void *)a2, (const void *)z)); returnCode(((0 != (const void *)((stdscr))) ? ((void)((0 != (const void *)(((a1)))) ? (*((a1)) = (stdscr)->_attrs) : (0)), (void)((0 != (const void *)(((a2)))) ? (*((a2)) = (short) ((int)((((unsigned long)(((stdscr)->_attrs)) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) >> 8)))) : (0)), (0)) : (-1)));
}
...
{
	T((T_CALLED("attr_set(%s,%#lx,%p)"), _traceattr2(0,a1), (long)a2, (const void *)z)); returnCode(((0 != (const void *)((stdscr))) ? ((void)((stdscr)->_attrs = ((((a1)) & ~((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) | (attr_t)(((chtype)((((a2)))) << ((0) + 8)) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))))), (0)) : (-1)));
}
...
{
	T((T_CALLED("COLOR_PAIR(%d)"), z)); returnCode((((chtype)(((z))) << ((0) + 8)) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))));
}
...
{
	T((T_CALLED("getbkgd(%p)"), (const void *)z)); returnChtype(((0 != (const void *)((z))) ? ((z)->_bkgd) : 0));
}
...
{
	T((T_CALLED("redrawwin(%p)"), (const void *)z)); returnCode(wredrawln(z, 0, ((0 != (const void *)((z))) ? (z)->_maxy+1 : -1)));
}
...
{
	T((T_CALLED("standout()"))); returnIntAttr((attr_t)(((0 != (const void *)((stdscr))) ? ((stdscr)->_attrs = (attr_t)(((chtype)((1U)) << ((8) + 8))), (0)) : (-1))));
}


NCURSES_EXPORT(int) (standend) (void)
{
	T((T_CALLED("standend()"))); returnIntAttr((attr_t)(((0 != (const void *)((stdscr))) ? ((stdscr)->_attrs = (attr_t)((1U - 1U)), (0)) : (-1))));
}
...
{
	T((T_CALLED("touchwin(%p)"), (const void *)z)); returnCode(wtouchln((z), 0, ((0 != (const void *)((z))) ? ((z)->_maxy + 1) : (-1)), 1));
}


NCURSES_EXPORT(int) (untouchwin) (WINDOW * z)
{
	T((T_CALLED("untouchwin(%p)"), (const void *)z)); returnCode(wtouchln((z), 0, ((0 != (const void *)((z))) ? ((z)->_maxy + 1) : (-1)), 0));
}
...
{
	T((T_CALLED("wattrset(%p,%d)"), (const void *)a1, z)); returnIntAttr((attr_t)((0 != (const void *)((a1))) ? ((a1)->_attrs = (attr_t)(z), (0)) : (-1)));
}


NCURSES_EXPORT(int) (wattr_get) (WINDOW * a1, attr_t * a2, short * a3, void * z GCC_UNUSED)
{
	T((T_CALLED("wattr_get(%p,%p,%p,%p)"), (const void *)a1, (const void *)a2, (const void *)a3, (const void *)z)); returnCode(((0 != (const void *)((a1))) ? ((void)((0 != (const void *)((a2))) ? (*(a2) = (a1)->_attrs) : (0)), (void)((0 != (const void *)((a3))) ? (*(a3) = (short) ((int)((((unsigned long)(((a1)->_attrs)) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) >> 8)))) : (0)), (0)) : (-1)));
}


NCURSES_EXPORT(int) (wattr_set) (WINDOW * a1, attr_t a2, short a3, void * z GCC_UNUSED)
{
	T((T_CALLED("wattr_set(%p,%s,%#lx,%p)"), (const void *)a1, _traceattr2(1,a2), (long)a3, (const void *)z)); returnCode(((0 != (const void *)((a1))) ? ((void)((a1)->_attrs = (((a2) & ~((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) | (attr_t)(((chtype)(((a3))) << ((0) + 8)) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))))), (0)) : (-1)));
}
...
{
	T((T_CALLED("wstandout(%p)"), (const void *)z)); returnIntAttr((attr_t)(((0 != (const void *)((z))) ? ((z)->_attrs = (attr_t)(((chtype)((1U)) << ((8) + 8))), (0)) : (-1))));
}


NCURSES_EXPORT(int) (wstandend) (WINDOW * z)
{
	T((T_CALLED("wstandend(%p)"), (const void *)z)); returnIntAttr((attr_t)(((0 != (const void *)((z))) ? ((z)->_attrs = (attr_t)((1U - 1U)), (0)) : (-1))));
}


NCURSES_EXPORT(int) (getattrs) (const WINDOW * z)
{
	T((T_CALLED("getattrs(%p)"), (const void *)z)); returnCode((int)((0 != (const void *)((z))) ? (z)->_attrs : (1U - 1U)));
}


NCURSES_EXPORT(int) (getcurx) (const WINDOW * z)
{
	T((T_CALLED("getcurx(%p)"), (const void *)z)); returnCode(((0 != (const void *)((z))) ? (z)->_curx : (-1)));
}


NCURSES_EXPORT(int) (getcury) (const WINDOW * z)
{
	T((T_CALLED("getcury(%p)"), (const void *)z)); returnCode(((0 != (const void *)((z))) ? (z)->_cury : (-1)));
}


NCURSES_EXPORT(int) (getbegx) (const WINDOW * z)
{
	T((T_CALLED("getbegx(%p)"), (const void *)z)); returnCode(((0 != (const void *)((z))) ? (z)->_begx : (-1)));
}


NCURSES_EXPORT(int) (getbegy) (const WINDOW * z)
{
	T((T_CALLED("getbegy(%p)"), (const void *)z)); returnCode(((0 != (const void *)((z))) ? (z)->_begy : (-1)));
}


NCURSES_EXPORT(int) (getmaxx) (const WINDOW * z)
{
	T((T_CALLED("getmaxx(%p)"), (const void *)z)); returnCode(((0 != (const void *)((z))) ? ((z)->_maxx + 1) : (-1)));
}


NCURSES_EXPORT(int) (getmaxy) (const WINDOW * z)
{
	T((T_CALLED("getmaxy(%p)"), (const void *)z)); returnCode(((0 != (const void *)((z))) ? ((z)->_maxy + 1) : (-1)));
}


NCURSES_EXPORT(int) (getparx) (const WINDOW * z)
{
	T((T_CALLED("getparx(%p)"), (const void *)z)); returnCode(((0 != (const void *)((z))) ? (z)->_parx : (-1)));
}


NCURSES_EXPORT(int) (getpary) (const WINDOW * z)
{
	T((T_CALLED("getpary(%p)"), (const void *)z)); returnCode(((0 != (const void *)((z))) ? (z)->_pary : (-1)));
}


NCURSES_EXPORT(WINDOW *) (wgetparent) (const WINDOW * z)
{
	T((T_CALLED("wgetparent(%p)"), (const void *)z)); returnWin(((0 != (const void *)((z))) ? (z)->_parent : 0));
}


NCURSES_EXPORT(NCURSES_BOOL) (is_cleared) (const WINDOW * z)
{
	T((T_CALLED("is_cleared(%p)"), (const void *)z)); returnBool(((0 != (const void *)((z))) ? (z)->_clear : 0));
}


NCURSES_EXPORT(NCURSES_BOOL) (is_idcok) (const WINDOW * z)
{
	T((T_CALLED("is_idcok(%p)"), (const void *)z)); returnBool(((0 != (const void *)((z))) ? (z)->_idcok : 0));
}


NCURSES_EXPORT(NCURSES_BOOL) (is_idlok) (const WINDOW * z)
{
	T((T_CALLED("is_idlok(%p)"), (const void *)z)); returnBool(((0 != (const void *)((z))) ? (z)->_idlok : 0));
}


NCURSES_EXPORT(NCURSES_BOOL) (is_immedok) (const WINDOW * z)
{
	T((T_CALLED("is_immedok(%p)"), (const void *)z)); returnBool(((0 != (const void *)((z))) ? (z)->_immed : 0));
}


NCURSES_EXPORT(NCURSES_BOOL) (is_keypad) (const WINDOW * z)
{
	T((T_CALLED("is_keypad(%p)"), (const void *)z)); returnBool(((0 != (const void *)((z))) ? (z)->_use_keypad : 0));
}


NCURSES_EXPORT(NCURSES_BOOL) (is_leaveok) (const WINDOW * z)
{
	T((T_CALLED("is_leaveok(%p)"), (const void *)z)); returnBool(((0 != (const void *)((z))) ? (z)->_leaveok : 0));
}


NCURSES_EXPORT(NCURSES_BOOL) (is_nodelay) (const WINDOW * z)
{
	T((T_CALLED("is_nodelay(%p)"), (const void *)z)); returnBool(((0 != (const void *)((z))) ? ((z)->_delay == 0) : 0));
}


NCURSES_EXPORT(NCURSES_BOOL) (is_notimeout) (const WINDOW * z)
{
	T((T_CALLED("is_notimeout(%p)"), (const void *)z)); returnBool(((0 != (const void *)((z))) ? (z)->_notimeout : 0));
}


NCURSES_EXPORT(NCURSES_BOOL) (is_pad) (const WINDOW * z)
{
	T((T_CALLED("is_pad(%p)"), (const void *)z)); returnBool(((0 != (const void *)((z))) ? ((z)->_flags & 0x10) != 0 : 0));
}


NCURSES_EXPORT(NCURSES_BOOL) (is_scrollok) (const WINDOW * z)
{
	T((T_CALLED("is_scrollok(%p)"), (const void *)z)); returnBool(((0 != (const void *)((z))) ? (z)->_scroll : 0));
}


NCURSES_EXPORT(NCURSES_BOOL) (is_subwin) (const WINDOW * z)
{
	T((T_CALLED("is_subwin(%p)"), (const void *)z)); returnBool(((0 != (const void *)((z))) ? ((z)->_flags & 0x01) != 0 : 0));
}


NCURSES_EXPORT(NCURSES_BOOL) (is_syncok) (const WINDOW * z)
{
	T((T_CALLED("is_syncok(%p)"), (const void *)z)); returnBool(((0 != (const void *)((z))) ? (z)->_sync : 0));
}


NCURSES_EXPORT(int) (wgetdelay) (const WINDOW * z)
{
	T((T_CALLED("wgetdelay(%p)"), (const void *)z)); returnCode(((0 != (const void *)((z))) ? (z)->_delay : 0));
}


NCURSES_EXPORT(int) (wgetscrreg) (const WINDOW * a1, int * a2, int * z)
{
	T((T_CALLED("wgetscrreg(%p,%p,%p)"), (const void *)a1, (const void *)a2, (const void *)z)); returnCode(((0 != (const void *)((a1))) ? (*(a2) = (a1)->_regtop, *(z) = (a1)->_regbottom, (0)) : (-1)));
}
